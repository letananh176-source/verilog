...
>ví dụ có phần thập phân.


**cách làm: nhân cho hệ số, lấy từ trên xuống dưới**

| hệ 10                    | kết quả | nhị phân |
| ------------------------ | ------- | -------- |
| 0,375                    | 0,75    | 0        |
| 0,75                     | 1,5     | 1        |
| 0,5 (1,5 bỏ phần nguyên) | 1       | 1        |
| 0                        | 0       | none     |
...
4 bit tiếp theo (chỉ còn 3, trước không có thêm 0)
...
> **Cách kiểm tra = casio**: Menu 3 => chọn hệ => nhập số => bấm "=" => chọn hệ chuyển
